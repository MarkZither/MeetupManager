...
#else
    public partial class OAuth2Authenticator2 : WebRedirectAuthenticator
#endif
    {
        string clientId;
        string clientSecret;
            ...
            : base(redirectUrl, redirectUrl)
        {
            ...
            */
             ...
             * @dsc here are my changes
             */
            this.responseType = OAuthFlowResponseTypeVerification();
        ...
        public override Task<Uri> GetInitialUrlAsync()
        {
            ...
            */
            Dictionary<string, string> query = new Dictionary<string, string>
            {
                ...
                {"response_type",  Uri.EscapeDataString(this.responseType)},
                //---------------------------------------------------------------------------------------
                /// Pull Request - manually added/fixed
            ...
            if (isNonceNeeded)
            {
                query.Add("nonce", Uri.EscapeDataString(this.requestNonce));
            }
